...
Class PseudoArray
{
	...
	/*
		v1.1 conversion
		; StringSplit	(param 1 - OutputARRAY_Name)					v1 deprecated- v1/v2 conversion

		v2.x conversion
		; StringSplit	(param 1 - OutputARRAY_Name)					v1 deprecated- v1/v2 conversion
		; WinGet		(param 1 - OutputVAR_Name)						do not change for v1.1 conversion
		; RegexMatch	(param 3 - OutputVAR_Name will become ARRAY)	do not change for v1.1 conversion
		...
		OutputVar "Len"
		OutputVar "Pos"
		OutputVar "Len" CaptName
		OutputVar "Pos" CaptName
	*/
	newname := ''
	/*
		VarName ".Length"
	...
	*/
	...
	; this is always true? so what is the purpose?
