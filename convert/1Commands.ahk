...
/* Commands and How to convert them
  Specification format:
    , "CommandName,Param1,Param2,etc",
      "Replacement string format"   (see AhkLangConv.ahk)
...
;      "*_Goto"
  ...
  , "MouseClickDrag,WhichButtonT2E,X1CBE2E,Y1CBE2E,X2CBE2E,Y2CBE2E,SpeedCBE2E,RelativeT2E" ,
      "MouseClickDrag({1}, {2}, {3}, {4}, {5}, {6}, {7})"
  , "MouseGetPos,OutputVarXV2VR,OutputVarYV2VR,OutputVarWinV2VR,OutputVarControlV2VR,Flag" ,
      "MouseGetPos({1}, {2}, {3}, {4}, {5})"
