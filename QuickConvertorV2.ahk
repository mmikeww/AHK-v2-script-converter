...
CompDiffV2(*)
{
   ...
   RunWait('"' A_ScriptDir '\diff\VisualDiff.ahk" "' A_ScriptDir '\diff\VisualDiff.ahk" "' . TempAhkFileV1 . '" "' . TempAhkFileV2 . '"')
...
CompDiffV2E(*)
{
  ...
  ; RunWait('"' A_ScriptDir '\diff\VisualDiff.exe" "' A_ScriptDir '\diff\VisualDiff.ahk" "' . TempAhkFileV2 . '" "' . TempAhkFileV2E . '"')
   RunWait('"' A_ScriptDir '\diff\VisualDiff.ahk" "' A_ScriptDir '\diff\VisualDiff.ahk" "' . TempAhkFileV2 . '" "' . TempAhkFileV2E . '"')
