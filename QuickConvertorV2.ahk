...
{ ;DIRECTIVES AND SETTINGS:
    ...
    FileEncoding "UTF-8"
    global gQCV2_Test := 0  ; 2026-01-21 AMB, 0 - UI will NOT be shown
}
{ ;INCLUDES:
...
{
    global gFilePath            ; 2026-01-21 AMB, ADDED support for new progress UI
    if (ParentItemID="0") {
    ...
    {
        ;LoadingFileName.Text := A_LoopFileName            ; 2026-01-21 AMB - removed
        If InStr( FileExist(A_LoopFileFullPath ), "D" ) {
            ...
            gFilePath := A_LoopFileFullPath            ; 2026-01-21 AMB, ADDED support for new progress UI
            ...
            if FileExist(FileFullPathAh2) {
                ...
                Number_Tests++
                if (TextExp==TextCnv){  ; 2026-01-21 AMB, UPDATED - now case-sensitive
...
EvalSelectedTest(thisCtrl, *)
{
    ...
    gFilePath   := file_ah1            ; 2026-01-21 AMB, ADDED support for new progress UI
...
GuiTest(strV1Script:="")
{
    ...
    ; 2026-01-21 AMB, REMOVED - support for new progress UI
    ...
    if TestMode{
        global gQCV2_Test := 1  ; 2026-01-21 AMB, 1 - UI WILL be shown
    ...
    ;LT.Hide()  ; 2026-01-21 AMB, REMOVED - support for new progress UI
    ...
    try Prog.Hide()            ; 2026-01-21 AMB, ADDED support for new progress UI
    Return
}
