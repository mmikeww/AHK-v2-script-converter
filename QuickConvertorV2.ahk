...
GuiTest(strV1Script:="")
{
    ...
    ConversionMenu := Menu()
    ConversionMenu.Add("OnMessage Fix", _FixOnMessage)
    ConversionMenu.Add("Min/MaxIndex Fix", _MinMaxIndexFix)
    ConversionMenu.Add("Win* Fix", _WinFuncsFix)
    ViewMenu := Menu()
    ...
    Menus.Add("&Conversion", ConversionMenu)
