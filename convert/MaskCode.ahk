/* DESCRIPTION AND CHANGE LOG
	...
	2026-01-01,13,17,21		- UPDATED, see comments in code
...
; 2026-01-21 AMB, UPDATED - added many missing keys, BUT SOME DRAG PERFORMANCE
	...
	; 2026-01-21 - THESE UNCOMMON KEYS SLOW THE CONVERSION TO A CRAWL !!
	; WILL GIVE USER THE OPTION TO INCLUDE THEM (FROM UI)
	;k12		:= '(?:ctrlbreak|help|pause|printscreen|sleep)							; 2026-01-21 ADDED - rare    keys
	;k13		:= '(?:browser_(?:back|favorites|forward|home|refresh|search|stop))'	; 2026-01-21 ADDED - browser keys
	;k14		:= '(?:volume_(?:down|mute|up))'										; 2026-01-21 ADDED - volume  keys
	;k15		:= '(?:media_(?:next|play|prev|stop))'									; 2026-01-21 ADDED - media   keys
	;k16		:= '(?:launch_(?:app[12]|mail|media))'									; 2026-01-21 ADDED - launch  keys

	repeat	:= '(?:\h++(?:&\h++)?(?-1))*'												; allow repeated keys
	hotKeys	:= '(?<HK>' k01 '(' k02 '(?:' k03 '|' k04 '|' k05 '|' k06					; assemble needle...
			. '|' k07 '|' k08 '|' k09 '|' k10 '|' k11 '))'								; ... continued ...
			;. '|' k12 '|' k13 '|' k14 '|' k15 '|' k16 '))'								; ... continued ... 2026-01-21 - WAY TOO SLOW !!
